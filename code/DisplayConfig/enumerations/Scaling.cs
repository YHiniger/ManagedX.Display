namespace ManagedX.Display.DisplayConfig
{
	...
	[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING" )]
	public enum Scaling : int
	{
		...
		/// </summary>
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_IDENTITY" )]
		Identity = 1,
		...
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_CENTERED" )]
		Centered = 2,

		/// <summary>The content is scaled to fit the path's target.</summary>
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_STRETCHED" )]
		Stretched = 3,

		/// <summary>The aspect-ratio centering transformation.</summary>
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_ASPECTRATIOCENTEREDMAX" )]
		...
		/// </summary>
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_CUSTOM" )]
		Custom = 5,
		...
		/// </summary>
		[Native( "WinGDI.h", "DISPLAYCONFIG_SCALING_PREFERRED" )]
		Preferred = 128
