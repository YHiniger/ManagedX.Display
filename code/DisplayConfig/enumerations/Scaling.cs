namespace ManagedX.Graphics.DisplayConfig
{
	...
	[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING" )]
	public enum Scaling : int
	{
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_IDENTITY" )]
		Identity = 1,
		...
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_CENTERED" )]
		Centered = 2,

		/// <summary>The content is scaled to fit the path's target.</summary>
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_STRETCHED" )]
		Stretched = 3,

		/// <summary>The aspect-ratio centering transformation.</summary>
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_ASPECTRATIOCENTEREDMAX" )]
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_CUSTOM" )]
		Custom = 5,
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAYCONFIG_SCALING_PREFERRED" )]
		Preferred = 128
