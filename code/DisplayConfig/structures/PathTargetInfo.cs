...
namespace ManagedX.Display.DisplayConfig
{
	...
	public struct PathTargetInfo : IEquatable<PathTargetInfo>
	{
		...
		/// For this case, in a call to the SetDisplayConfig function, the caller must set the scanLineOrdering member to <see cref="Display.ScanLineOrdering.Unspecified"/>; otherwise, SetDisplayConfig fails.
		/// </summary>
