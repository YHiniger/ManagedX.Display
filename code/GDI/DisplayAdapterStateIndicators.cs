...
namespace ManagedX.Graphics
{
	...
	[System.Flags]
	public enum DisplayAdapterStateIndicators : int
	{
		...
		[Source( "WinGDI.h", "DISPLAY_DEVICE_ATTACHED_TO_DESKTOP" )]
		AttachedToDesktop = 0x00000001,

		/// <summary>No documentation.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Multi" )]
		[Source( "WinGDI.h", "DISPLAY_DEVICE_MULTI_DRIVER" )]
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_PRIMARY_DEVICE" )]
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_MIRRORING_DRIVER" )]
		...
		/// </summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_UNSAFE_MODES_ON" )]
		UnsafeModesOn = 0x00080000,


		/// <summary>No documentation.</summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_TS_COMPATIBLE" )]
		...
		/// <para>This value is present since Windows 2000.</para>
		/// </summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_DISCONNECT" )]
		Disconnect = 0x02000000,

		/// <summary>No documentation.
		/// <para>This value is present since Windows 2000.</para>
		/// </summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_REMOTE" )]
		Remote = 0x04000000,

		/// <summary>The device has more display modes than its output devices support.</summary>
		[Source( "WinGDI.h", "DISPLAY_DEVICE_MODESPRUNED" )]
